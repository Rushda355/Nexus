...
const initialTransactions: Transaction[] = [
  ...
  },
  {
    ...
    type: "Transfer",
    amount: 15000,
    sender: "Sara Khan (Investor)",
    receiver: "TechStart Inc.",
    status: "Completed",
    date: "2026-05-09",
    description: "Series A funding - Milestone 1",
  },
  {
    id: "t3",
    type: "Transfer",
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Manage your wallet, transactions and deal funding
        </p>
      </div>

      {/* Success Toast */}
      {showSuccess && (
        <div className="fixed top-6 right-6 bg-green-500 text-white px-6 py-3 rounded-xl shadow-lg z-50 font-medium">
          {successMsg}
        </div>
      )}
        ...
        <div className="xl:col-span-1 flex flex-col gap-4">
          ...
          {activeTab === "wallet" && (
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl p-5 text-white mb-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="bg-green-50 hover:bg-green-100 text-green-700 py-2 rounded-lg text-sm font-medium transition-colors"
                >
                  ⬇️ Deposit
                </button>
                <button
                  onClick={() => setActiveTab("withdraw")}
                  className="bg-red-50 hover:bg-red-100 text-red-700 py-2 rounded-lg text-sm font-medium transition-colors"
                >
                  ⬆️ Withdraw
                </button>
                <button
                  onClick={() => setActiveTab("transfer")}
                  className="bg-blue-50 hover:bg-blue-100 text-blue-700 py-2 rounded-lg text-sm font-medium transition-colors"
                >
                  ↔️ Transfer
                </button>
                <button
                  onClick={() => setActiveTab("fund")}
                  className="bg-purple-50 hover:bg-purple-100 text-purple-700 py-2 rounded-lg text-sm font-medium transition-colors"
                >
                   Fund Deal
                </button>
              </div>
          ...
          {activeTab === "deposit" && (
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              <h3 className="font-semibold text-gray-900 mb-4">⬇️ Deposit Funds</h3>
              <div className="space-y-3">
                ...
                <div className="bg-gray-50 rounded-lg p-3 text-xs text-gray-500">
                  💳 Simulated payment via Stripe
                </div>
                <button
                  onClick={() => handleTransaction("Deposit")}
                  className="w-full bg-green-500 hover:bg-green-600 text-white py-2.5 rounded-lg text-sm font-medium transition-colors"
                >
                  Confirm Deposit
                </button>
              </div>
          ...
          {activeTab === "withdraw" && (
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              <h3 className="font-semibold text-gray-900 mb-4">⬆️ Withdraw Funds</h3>
              <div className="space-y-3">
                <div className="bg-blue-50 rounded-lg p-3 text-sm">
                  <p className="text-gray-500 text-xs">Available Balance</p>
                  <p className="font-bold text-blue-700">${walletBalance.toLocaleString()}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Amount ($)</label>
                  <input
          ...
          {activeTab === "transfer" && (
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              <h3 className="font-semibold text-gray-900 mb-4">↔️ Transfer Funds</h3>
              <div className="space-y-3">
                <div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              ...
              <div className="space-y-3">
                <div className="bg-purple-50 rounded-lg p-3">
                  <p className="text-xs text-gray-500">From (Investor)</p>
                  <p className="text-sm font-medium text-gray-900">Sara Khan</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Entrepreneur / Startup</label>
                  <input
                    type="text"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g. Series A - Milestone 1"
                    value={description}
                    onChange={(e) => setDescription(e.target.value)}
                    className="mt-1 w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-100">
                    ...
                    <th className="text-left text-xs font-semibold text-gray-500 pb-3">Sender</th>
                    <th className="text-left text-xs font-semibold text-gray-500 pb-3">Receiver</th>
                ...
                <tbody className="divide-y divide-gray-50">
                  {filteredTransactions.map((t) => (
                    <tr key={t.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-3 text-sm text-gray-600 max-w-32 truncate">
                        {t.description}
                      </td>
                      <td className="py-3 text-sm text-gray-600 max-w-32 truncate">
                        {t.sender}
